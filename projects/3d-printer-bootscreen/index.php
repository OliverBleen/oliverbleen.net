  ...
  <body>
    <div class="text-box projects">
      <div id="Table_of_contents">
        <h1 class="link-container"><a href="../">Projects</a> / 3D Printer Bootscreen</h1>
      </div>
      <div id="3D_Printer_Bootscreen" class="image-width-limited">
        ...
        <p class="sidenote">
          (Despite what the comment in <a class="code sidenote">BOOTSCREEN_TIMEOUT</a> says, from testing it seems that these two timeouts add up. Also, I haven't tried to set one of the Timeouts to <a class="code sidenote">0</a>, as I thought that that might break some stuff.)</br>
        </p>
      </div>
    </div>
