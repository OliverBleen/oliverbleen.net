...
<?php
  session_start();
  $counter_name = '/home/WH540322993/wwwroot/VisitsCounter-404.txt';
...
<html>
  <head>
    ...
    <title>Oliver Bleen - 404 Not found</title>
  </head>
  <body>

    <div class="text-box">
      <h1>404: Not found x3</h1>
      <p>The page you are looking for does not exist, sowwy</p>
      <p class="link-container">Click <a href="/">here</a> to get to the main page</p>
    </div>
